...
namespace tivars
{
    ...
    data_t TH_RealList::makeDataFromString(const string& str, const options_t& options)
    {
        (void)options;
    ...
    string TH_RealList::makeStringFromData(const data_t& data, const options_t& options)
    {
        (void)options;
